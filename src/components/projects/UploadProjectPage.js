        ...
        <div className="wrapper">
                ...
                <Form onSubmit={handleSubmit}>
                  <Form.Group className="m-3 " id="display">
                    <Form.Label for="projec title">Project Name</Form.Label>
                  ...
                  <Form.Group controlId="formFile" className="m-3">
                    <Form.Label for="cover art image">Project Cover Image</Form.Label>
                    <Form.Control onChange={(e) => setImageFile(e.target.files[0])} type="file" ref={imageRef} />
                  </Form.Group>
                  <Form.Group controlId="formFile" className="m-3">
                    <Form.Label for="audio file">Project Audio File</Form.Label>
